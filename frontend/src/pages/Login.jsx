    ...
    <div className="auth-shell" style={pageStyle}>
      ...
      >
        <div>
          ...
          >
            Grow events, track trees, and manage your planting network in one
            place.
          </h1>
          <p
            style={{
          ...
          >
            Sign in as a volunteer, sponsor, or organization and manage planting
            campaigns with live progress, requests, and tree-level tracking.
          </p>
        </div>
      ...
      >
        <div
          style={{
            ...cardStyle,
            padding: isMobile ? "22px" : cardStyle.padding,
            borderRadius: isMobile ? "22px" : cardStyle.borderRadius,
          }}
        >
          <div
            style={{
          ...
          <p
            style={{ color: "#52796f", marginBottom: "28px", lineHeight: 1.6 }}
          >
            Use your account to manage campaigns, approvals, and tree lifecycle
            updates.
          </p>
          ...
          <div
            style={{ marginTop: "22px", color: "#52796f", textAlign: "center" }}
          >
            New here?{" "}
